...
import { Building, AlertCircle, Loader2, ArrowLeft } from "lucide-react";
    ...
    try {
      ...
      if (data.user) {
        ...
        if (profileError || !profile || profile.role !== 'company') {
          ...
          setError("Access denied. This login is only for Company representatives.");
          return;
        }
      }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Enter your authorized company credentials to access the system
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <Alert className="mb-4">
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  <strong>Note:</strong> Company accounts are pre-authorized. If you don't have credentials, 
